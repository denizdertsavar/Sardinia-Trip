...
const DAYS = [
  ...
  },
  {
    ...
    logistics: "Santa Teresa → Olbia Airport: 1h. Porto Cervo detour adds ~25 min.",
  ...
  },
  {
    ...
    anchor: [
      ...
      { time: "Afternoon", text: "Palau → La Maddalena ferry (every 15–30 min, ~20 min, ~€16 foot / ~€40 with car). Drive to Caprera for Cala Coticcio (\"Tahiti beach\" — 20 min walk in). Or half-day boat tour to Spargi, Budelli & Santa Maria (~€40 pp)." },
    ...
    logistics: "Santa Teresa → Porto Pollo: 40 min. Wind builds midday — mornings flatter, afternoons stronger.",
